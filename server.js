...
app.listen(PORT, () => {
    console.log(
        `Exact Help API: Running in ${process.env.NODE_ENV} mode and listening on port http://:${PORT}`
    );
    logger.debug(`Exact Help API: Running in ${process.env.NODE_ENV} mode and listening on port http://:${PORT}`);
});
